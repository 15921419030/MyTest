<%@ Page Language="vb" AutoEventWireup="false"  EnableViewstate ="false" CodeBehind="DivTest.aspx.vb" Inherits="NhibernateWeb.DivTest" %>
...
<head runat="server">
    <title></title>
    <script type="text/javascript" src="<%=ConfigurationManager.AppSettings("basepath") + HttpRuntime.AppDomainAppVirtualPath%>/Js/jquery-1.7.2.js,colorbox/jquery.colorbox-min.js"></script>
    <style type="text/css">
    ...
    <link type="text/css" href=<%=basepath%> />
</head>
<body>
    <form id="form1">
    <div>
    引用多个js文件
    <asp:Label ID="myview" runat="server"></asp:Label>
    </div>
    <div>
        <img src="<%=ConfigurationManager.AppSettings("basepath") + HttpRuntime.AppDomainAppVirtualPath%>/Images/0002.jpg" width="200" height="200" />
    </div>
    </form>
</body>
</html>
